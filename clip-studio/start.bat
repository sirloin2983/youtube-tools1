...
echo.
echo ----------------------------------------------------------
echo  Server stopped (exit code %errorlevel%). Log: studio.log in this folder.
echo  If you did not stop it yourself, please send the messages above and studio.log.
echo ----------------------------------------------------------
pause
